...
<script src="<c:url value="/resources/js/answerRecord/show.js"/>" type="text/javascript"></script>
...
<c:if test="${choices!=0}">
    <h4>选择题（共${choices}题）</h4>
        ...
        <div style="float: right;"><r:a href="/combinedQuestion/${question.id}/review" class="label label-info"><i class="icon-bookmark icon-white"></i>复习巩固</r:a></div>
